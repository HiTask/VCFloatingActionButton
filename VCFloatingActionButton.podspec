Pod::Spec.new do |s|
  ...
  s.source_files  = "VCFloatingActionButton/floatingButtonTrial", "VCFloatingActionButton/floatingButtonTrial/VCFloatingActionButton/ 
", "VCFloatingActionButton", "VCFloatingActionButton/floatingButtonTrial/VCFloatingActionButton/*.{h,m,xib}"
